...
class Media_Library_Organizer_Block {
	...
	/**
	 * Registers this block with the Plugin.
	 *
	 * @since   1.4.9
	 *
	...
	public function register( $blocks ) {
		...
		$blocks[ $this->get_name() ] = array_merge(
			...
			array(
				'name'           => $this->get_name(),
				'prefix'         => Media_Library_Organizer()->get_class( 'shortcode' )->get_prefix(), // e.g. media_library_organizer.
	...
	/**
	 * Returns this block's programmatic name, excluding the mlo- prefix.
	 *
	 * @since   1.4.9
	 */
	...
	public function sanitize_and_declare_atts( $atts ) {
		...
		$atts['_css_classes'] = array( 'mlo-' . $this->get_name() );

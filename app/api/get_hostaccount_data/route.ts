...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('Fetching host account for user ID:', userInternalId);
    ...
    console.log(`Found ${hostAccounts?.length || 0} host account records for user`);
    ...
    console.error('get_hostaccount_data API error:', error);
    return NextResponse.json(

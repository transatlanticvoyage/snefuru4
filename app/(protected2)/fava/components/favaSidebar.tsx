  ...
  const fetchNavigation = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const { adminMenuItem, specialFirstItem, oldAllGroupItem, plutoJetstreamItem, hardcodedNavItems } = createNavigationStructure(rawNavData);
        
        // Combine into final navigation structure (same as main app)
        const finalNavigation = [adminMenuItem, plutoJetstreamItem, specialFirstItem, oldAllGroupItem, ...hardcodedNavItems];

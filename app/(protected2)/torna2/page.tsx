...
export default function Torna2Page() {
  ...
  // Prepare table props
  const tableProps = {
    headerRows: torna2TableConfig.headerRows,
    data: data,
  ...
  return (
    <FavaPageMaster
      ...
      pageDescription={`${nemtorData.length} units • ${torna2TableConfig.columns.length} data columns • Elementor widget management system`}

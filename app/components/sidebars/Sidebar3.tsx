...
export default function Sidebar3({ isOpen, onToggle, showToggleButton = true, onHeaderVisibilityChange }: SidebarMenuProps) {
      ...
      style={{
        ...
        <div className="p-4 border-t border-gray-700">
          <div className="flex items-center text-xs text-gray-400">
            ...
            Full Navigation Menu - Advanced Admin System
          </div>
        </div>
      </div>

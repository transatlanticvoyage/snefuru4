...
const tbn2_headerCustomizationSettings = {
  ...
  headerTextAlign: {
    ...
    fk_image3_id: 'center',
    fk_image4_id: 'center',
    'image1-preview': 'center',
    'image2-preview': 'center',
    'image3-preview': 'center',
    'image4-preview': 'center',
    id: 'left',
    rel_users_id: 'center',
    rel_images_plans_batches_id: 'center',
    created_at: 'center',
    e_zpf_img_code: 'left',
    e_width: 'center',
    e_height: 'center',
    e_associated_content1: 'left',
    e_file_name1: 'left',
    e_more_instructions1: 'left',
    e_prompt1: 'left',
    e_ai_tool1: 'center',

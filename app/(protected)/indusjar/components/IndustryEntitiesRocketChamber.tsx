...
interface IndustryEntitiesRocketChamberProps {
  data: any[];
...
export default function IndustryEntitiesRocketChamber({
  data,
  onPaginationRender,
  searchValue,
  onSearchChange,
  onPillarShiftClick,
  onIndustryOptionsClick,
  currentPage,
  itemsPerPage,
  onPageChange,
  ...
  const filteredData = useMemo(() => {
    return data.filter(item => {
      ...
      return (
        item.industry_name?.toLowerCase().includes(searchLower) ||
        item.emd_stamp_slug?.toLowerCase().includes(searchLower) ||
        item.industry_description?.toLowerCase().includes(searchLower)
      );
    });
  }, [data, searchValue]);
            ...
            <table style={{ borderCollapse: 'collapse' }}>
              <tbody>
                ...
                <tr>
                  ...
                  <td style={{ border: '1px solid black', padding: '4px' }}>
                    <div className="flex items-end">
                      <input
                        ...
                        placeholder="Search industry entities..."
                  ...
                  <td style={{ border: '1px solid black', padding: '4px' }}>
                    <button
                      onClick={onIndustryOptionsClick}

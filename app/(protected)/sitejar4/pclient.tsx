...
export default function Sitejar4Client() {
...
http://www.drogs.com`}
                ...
                {activePopupTab === 'ptab5' && (
                  <div>
                    <h3 className="text-lg font-semibold mb-4">Site Management Tools</h3>
                    <p className="text-gray-600">This tab is available for additional site management tools.</p>
                  </div>
                )}
                ...
                {activePopupTab === 'ptab7' && (
                  <div>
                    ...
                    <div className="bg-white p-4 rounded-lg shadow border mb-4">
                      <div className="text-sm font-semibold text-gray-600 mb-1">box_area_2</div>

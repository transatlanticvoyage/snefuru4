...
output_file = os.path.join(folder_path, "agg1 - created by claude code.txt")
                ...
                for row_idx in range(1, min(21, sheet.max_row + 1)):
                    for col_idx in range(1, sheet.max_column + 1):
                        ...
                        if cell_value:
                            ...
                            if 'Profiles URLs' in cell_str or 'Live Backlinks' in cell_str or 'Profile URLs' in cell_str:
                                header_row = row_idx
                                url_column = col_idx

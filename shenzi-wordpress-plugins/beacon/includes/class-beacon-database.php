...
class Beacon_Database {
    ...
    public function __construct() {
        ...
        register_activation_hook(BEACON_PLUGIN_PATH . 'beacon.php', array($this, 'on_activation'));
    }
    ...
    public function maybe_create_tables() {
        $installed_version = get_option('beacon_zen_db_version', '0');
        
        if (version_compare($installed_version, self::ZEN_DB_VERSION, '<')) {
            $this->create_zen_tables();
            update_option('beacon_zen_db_version', self::ZEN_DB_VERSION);
        }
    }

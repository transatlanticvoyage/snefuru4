                                        ...
                                        <td style="border: 1px solid black; padding: 4px;">
                                            <div style="display: flex; align-items: end; gap: 16px;">
                                                ...
                                                <div style="display: flex; align-items: center;">
                                                    ...
                                                    <button type="button" data-cols="8" class="grove-cols-per-page-btn active" style="padding: 10px 8px; font-size: 14px; padding-top: 10px; padding-bottom: 10px; border: 1px solid #000; background: #f8f782; color: black; margin-right: -1px; cursor: pointer;">8</button>
